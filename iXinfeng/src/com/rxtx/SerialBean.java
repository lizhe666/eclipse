...
/**
 * 
 * This bean provides some basic functions to implement full duplex information
 * exchange through the serial port.
 * 
 */
    ...
    public int Initialize() {
        ...
        try {
            ...
            try {
                ...
                if (!SerialBean.portId.getCurrentOwner().equals(
